...
public class IapsManager : MonoBehaviour, IStoreListener {
    ...
    private const string KProductIdCoins1 =    "consumable";   
    private const string KProductIdCoins2 =    "consumable";   
    private const string KProductIdCoinsUnlockAll =    "consumable";   
    private const string KProductIdNoAds =    "consumable";   
...
//    private const string KProductNameGooglePlaySubscription =  "com.unity3d.subscription.original";
    ...
    {
        BuyProductId(KProductIdCoinsUnlockAll);
    ...
    private void InitializePurchasing() 
    {
        ...
        builder.AddProduct(KProductIdCoins1, ProductType.Consumable);
        builder.AddProduct(KProductIdCoins2, ProductType.Consumable);
        // Continue adding the non-consumable product.
        builder.AddProduct(KProductIdCoinsUnlockAll, ProductType.NonConsumable);
...
//        });
    ...
    public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args) 
    {
        ...
        if (String.Equals(args.purchasedProduct.definition.id, KProductIdCoins1, StringComparison.Ordinal))
        {
            Debug.Log(string.Format("ProcessPurchase: PASS. Product: '{0}'", args.purchasedProduct.definition.id));
            // The consumable item has been successfully purchased, add 100 coins to the player's in-game score.
//            ScoreManager.score += 100;
        }// A consumable product has been purchased by this user.
        if (String.Equals(args.purchasedProduct.definition.id, KProductIdCoins2, StringComparison.Ordinal))
        {
            Debug.Log(string.Format("ProcessPurchase: PASS. Product: '{0}'", args.purchasedProduct.definition.id));
            // The consumable item has been successfully purchased, add 100 coins to the player's in-game score.
//            ScoreManager.score += 100;
        ...
        else if (String.Equals(args.purchasedProduct.definition.id, KProductIdCoinsUnlockAll, StringComparison.Ordinal))
        {
            Debug.Log(string.Format("ProcessPurchase: PASS. Product: '{0}'", args.purchasedProduct.definition.id));
