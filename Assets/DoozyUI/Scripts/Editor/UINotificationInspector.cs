...
public class UINotificationInspector : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        ) //we check if this notification has at least a notification container attached (if not, we disable it)
        ...
        EditorGUILayout.BeginHorizontal();
        {
            ...
            uiNotification.showHelp =
                EditorGUILayout.ToggleLeft("Show Help", uiNotification.showHelp, GUILayout.Width(80));
            DoozyUIHelper.SetZoneColor(DoozyUIHelper.DoozyColor.Doozy);
            ...
            uiNotification.listenForBackButton =
                EditorGUILayout.ToggleLeft("Listen for Back Button", uiNotification.listenForBackButton);
        ...
        if (uiNotification.showHelp)
        {
            ...
            EditorGUILayout.HelpBox(
                "This is a chld gameObject of the notification, with an UIElement component attached, that will serve as the main container of all the other notification elements. It should contain everything besides the overlay.",
                MessageType.None);
            EditorGUILayout.HelpBox(
        ...
        if (uiNotification.notificationContainer != null)
        {
            ...
            if (uiNotification.showHelp)
            {
                ...
                DoozyUIHelper.ResetColors();
                EditorGUILayout.HelpBox(
                    "This gameobject should have either a Text or a TextMeshProUGUI component attached.",
                    MessageType.None);
                EditorGUILayout.HelpBox(
                    "If you used a TextMeshProUGUI componenet make sure TextMeshPro it is enabled in the UIManager or the Control Panel.",
                    MessageType.None);
                DoozyUIHelper.SetZoneColor(DoozyUIHelper.DoozyColor.Doozy);
            }
        ...
        if (uiNotification.notificationContainer != null)
        {
            ...
            if (uiNotification.showHelp)
            {
                ...
                DoozyUIHelper.ResetColors();
                EditorGUILayout.HelpBox(
                    "Every notification can have a customized icon or you can leave it null. Link the Image component here and pass in the icon Sprite when you call the ShowNotification method.",
                    MessageType.None);
                DoozyUIHelper.SetZoneColor(DoozyUIHelper.DoozyColor.Doozy);
            }
        ...
        if (uiNotification.notificationContainer != null)
        {
            ...
            if (uiNotification.showHelp)
            {
                ...
                DoozyUIHelper.ResetColors();
                EditorGUILayout.HelpBox(
                    "This is a special button as it coveres the entire notification area. This allows the user to dismiss at once the notification, just by touching/clicking on it.",
                    MessageType.None);
                EditorGUILayout.HelpBox(
                    "TIP: you can attach a Button component to the Overlay. link it here and have a full screen close button",
                    MessageType.None);
                DoozyUIHelper.SetZoneColor(DoozyUIHelper.DoozyColor.Doozy);
            }
        ...
        if (uiNotification.notificationContainer != null)
        {
            ...
            if (uiNotification.showHelp)
            {
                ...
                DoozyUIHelper.ResetColors();
                EditorGUILayout.HelpBox(
                    "These are the buttons you would like to be available for this notification. They can be turned on or off when you call the ShowNotification method.",
                    MessageType.None);
        ...
        if (uiNotification.notificationContainer != null)
        {
            ...
            if (uiNotification.showHelp)
            {
                ...
                DoozyUIHelper.ResetColors();
                EditorGUILayout.HelpBox(
                    "If you added stars or anything else with an UIElement attached, you need to link it here",
                    MessageType.None);
                DoozyUIHelper.SetZoneColor(DoozyUIHelper.DoozyColor.Doozy);
            }
    ...
    private void LinkChildUIElementsToNotification()
    {
        var childUIElements = uiNotification.GetComponentsInChildren<UIElement>(true);
    ...
    private SerializedProperty sp_notificationContainer;
    private SerializedProperty sp_overlay;
    private SerializedProperty sp_title;
    private SerializedProperty sp_message;
    private SerializedProperty sp_icon;
    private SerializedProperty sp_buttons;
    private SerializedProperty sp_closeButton;
    private SerializedProperty sp_specialElements;
    private SerializedProperty sp_effects;
